...
# Legacy function-based tests have been REMOVED - Use class methods above
# test_timezone_conversion() was replaced by TestConfigurationScenarios.test_timezone_conversion()